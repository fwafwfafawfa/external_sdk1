...
namespace offsets {
    ...
    inline constexpr uintptr_t AutoJumpEnabled = 0x1d9;
    ...
    inline constexpr uintptr_t DataModel_ScriptContext = 0x3f0;
    ...
    inline constexpr uintptr_t FFlags_DebugDisableTimeoutDisconnect = 0x662f8a8;
    inline constexpr uintptr_t FFlags_EnableLoadModule = 0x661eb88;
    inline constexpr uintptr_t FFlags_PartyPlayerInactivityTimeoutInSeconds = 0x65e3da4;
    inline constexpr uintptr_t FFlags_TaskSchedulerTargetFps = 0x6f49f28;
    inline constexpr uintptr_t FFlags_WebSocketServiceEnableClientCreation = 0x663c738;
    ...
    inline constexpr uintptr_t GuiPosition = 0x520;
    inline constexpr uintptr_t GuiRotation = 0x188;
    inline constexpr uintptr_t GuiSize = 0x540;
    ...
    inline constexpr uintptr_t JobsPointer = 0x78e3008;
    ...
    inline constexpr uintptr_t MaterialType = 0x228;
    ...
    inline constexpr uintptr_t PhysicsSenderMaxBandwidthBps = 0x65E426C;
